...
To help illuminate how the balance of these incentives changed between 1550--1750, we can turn to network analysis.
...
The data for this study have been drawn from the collections of the British Museum in London (hereafter BM) and the Rijksmuseum in Amsterdam (hereafter RKM).
...
For example, the print in Figure \ref@(fig:goldzius-wedding) would be used to create a connection between 
[For an in-depth discussion of these data and the methodology for inferring production networks from object-based collections, see @lincoln2016-2.]
